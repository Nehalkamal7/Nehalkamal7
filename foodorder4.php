...
#output { width: 50%; margin: 20px auto; border: 1px solid #ddd; padding: 10px; }
#language-select { margin-bottom: 10px; }
label { display: block; margin-bottom: 5px; }
input[type="text"], input[type="number"] { width: 100%; padding: 8px; margin-bottom: 10px; border: 1px solid #ccc; }
</style>
</head>
<body>
...
<form method="post" action="">
  <label for="address">عنوانك:</label>
